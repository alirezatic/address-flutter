...
class _AnimatedStartButtonState extends State<AnimatedStartButton>
  ...
  bool get _canTap => widget.isEnabled && !widget.isLoading;
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedOpacity(
      ...
      child: GestureDetector(
        ...
        onTapDown: _canTap ? _tapDown : null,
        onTapUp: _canTap ? _tapUp : null,
        onTapCancel: _canTap ? _tapCancel : null,
        onTap: _canTap ? widget.onTap : null,
        child: RepaintBoundary(
          child: AnimatedBuilder(
            animation: Listenable.merge(<Listenable>[_glow, _sweep, _press]),
