  ...
  Widget _buildBody(BuildContext context) {
    ...
    return switch (_controller.state) {
      ...
      DistributionOrderDetailsState.loaded => RefreshIndicator(
        ...
        child: _DistributionOrderDetailsContent(order: _controller.order!),
      ),
    };
  }
}
...
class _DistributionOrderDetailsContent extends StatelessWidget {
  const _DistributionOrderDetailsContent({required this.order});
              ...
              Wrap(
                ...
                children: [
                  ...
                  DistributionStatusBadge(
                    ...
                    tone: distributionDeliveryBadgeTone(order.deliveryState),
                  ),
                ],
              ),
            ],
...
class _OrderLinesSection extends StatelessWidget {
  const _OrderLinesSection({required this.lines});
          ...
          Wrap(
            ...
            children: [
              _LineValue(
                ...
                value: distributionNumberLabel(context, line.orderedQuantity),
              ),
              _LineValue(
                label: localizations.unitPrice,
                value: distributionNumberLabel(context, line.unitPrice),
              ),
              _LineValue(
                label: localizations.finalUnitPrice,
                value: distributionNumberLabel(context, line.finalUnitPrice),
              ),
            ],
          ),
        ],
