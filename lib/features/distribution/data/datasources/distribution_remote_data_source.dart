...
class DistributionRemoteDataSource {
  ...
  Future<DistributionOrdersPageModel> getOrders({
    ...
    try {
      ...
      return DistributionOrdersPageModel.fromJson(_responseMap(response.data));
    } on DioException catch (error) {
      throw _mapDioException(error);
    } on FormatException catch (error) {
      throw DistributionFailure(
  ...
  Future<DistributionOrderDetailsModel> getOrder(String name) async {
    try {
      ...
      return DistributionOrderDetailsModel.fromJson(_objectMap(orderJson));
    } on DioException catch (error) {
      throw _mapDioException(error);
    } on FormatException catch (error) {
      throw DistributionFailure(
  ...
  void _addQueryValue(Map<String, Object> query, String key, String? value) {
