...
class DistributionOrderSummaryModel extends DistributionOrderSummary {
  ...
  factory DistributionOrderSummaryModel.fromJson(Map<String, dynamic> json) {
...
class DistributionOrderDetailsModel extends DistributionOrderDetails {
  ...
  factory DistributionOrderDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    return DistributionOrderDetailsModel(
      ...
      plannedDeliveryDate: _nullableDate(json['planned_delivery_date']),
      createdAt: _requiredDate(json, 'create_date'),
      walletReservedAmount: _requiredDouble(json, 'wallet_reserved_amount'),
      walletCapturedAmount: _requiredDouble(json, 'wallet_captured_amount'),
      ...
      deliveryProofReference: _nullableString(json['delivery_proof_reference']),
...
class DistributionOrdersPageModel extends DistributionOrdersPage {
  ...
  factory DistributionOrdersPageModel.fromJson(Map<String, dynamic> json) {
...
class DistributionServiceStatusModel extends DistributionServiceStatus {
  ...
  factory DistributionServiceStatusModel.fromJson(Map<String, dynamic> json) {
