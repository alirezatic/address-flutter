...
void main() {
  group('Distribution API models', () {
    test('parses order list and false delivery date', () {
      final page = DistributionOrdersPageModel.fromJson(<String, dynamic>{
        'pagination': <String, dynamic>{'limit': 3, 'returned': 2},
        'count': 2,
        'orders': <Object>[
          <String, dynamic>{
            'id': 70,
      ...
      expect(page.orders.first.plannedDeliveryDate, DateTime(2026, 7, 15));
      expect(page.orders.last.plannedDeliveryDate, isNull);
    });

    test('parses order details, references and lines', () {
      final order = DistributionOrderDetailsModel.fromJson(<String, dynamic>{
        'id': 70,
        'name': 'DOR/2026/00070',
        'state': 'received',
        'amount_total': 9.03,
        ...
        'delivery_state': 'delivered',
        'planned_delivery_date': '2026-07-15',
        'delivery_driver_id': <Object>[6, 'Delivery Golden Driver'],
    ...
    test('parses reachable service status', () {
      final status = DistributionServiceStatusModel.fromJson(<String, dynamic>{
        'mode': 'clone',
        'scope': 'clone-only',
        'odoo': <String, dynamic>{
