...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _showLanguagePicker() async {
    ...
    final languages = <_LanguageOption>[
      const _LanguageOption(code: 'fa', label: 'فارسی', flag: '🇮🇷'),
      const _LanguageOption(code: 'en', label: 'English', flag: '🇺🇸'),
      const _LanguageOption(code: 'ar', label: 'العربية', flag: '🇸🇦'),
      const _LanguageOption(code: 'zh', label: '中文', flag: '🇨🇳'),
    ];
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final menuWidth = width < 600 ? 286.0 : 320.0;
              ...
              RepaintBoundary(
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    return Transform.translate(
                      offset: Offset(progress * dashboardShift * direction, 0),
              ...
              AnimatedBuilder(
                ...
                builder: (context, child) {
                  return PositionedDirectional(
                    top: topPadding + 8,
                    start: 8 + _menuAnimation.value * (menuWidth - 72),
                    child: child!,
                  );
                },
