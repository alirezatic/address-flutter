    ...
    return AnimatedBuilder(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final mainImageWidth = (width * (compact ? 0.66 : 0.60))
              .clamp(190, 430)
              .toDouble();
          final mainImageHeight = (height * 0.38).clamp(82, 132).toDouble();
          final vehicleWidth = (width * 0.23).clamp(70, 150).toDouble();
                ...
                if (widget.service.secondaryImage.isNotEmpty)
                  PositionedDirectional(
                    ...
                    child: AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return Transform.translate(
                          offset: Offset(0, _floatingAnimation.value * 0.45),
                          child: child,
                        );
                      },
                      child: Image.asset(
