...
void main() {
  ...
  testWidgets('orders screen renders on a compact viewport', (tester) async {
    ...
    await tester.pumpWidget(
      _TestApp(
        child: DistributionOrdersScreen(repository: repository),
      ),
    );
...
class _WidgetTestDistributionRepository
    implements DistributionRepository {
  ...
  Future<DistributionOrderDetails> getOrder(String name) async {
    return DistributionOrderDetails(
      ...
      deliveryTrip: const DistributionReference(
        id: 21,
        name: 'DTR/2026/00021',
      ),
      ...
      lines: const <DistributionOrderLine>[
        DistributionOrderLine(
          id: 70,
          order: DistributionReference(
            id: 70,
            name: 'DOR/2026/00070',
          ),
          product: DistributionReference(
            id: 3,
            name: 'PILOT PRODUCT 001',
          ),
          unitOfMeasure: DistributionReference(
            id: 1,
            name: 'Units',
          ),
          orderedQuantity: 1,
