...
class DistributionOrdersScreen extends StatefulWidget {
  const DistributionOrdersScreen({
    this.repository,
    super.key,
  });
...
class _DistributionOrdersScreenState extends State<DistributionOrdersScreen> {
  ...
  void initState() {
    ...
    _controller = DistributionOrdersController(
  ...
  Future<void> _openOrder(
    DistributionOrderSummary order,
  ) async {
    final location = Uri(
  ...
  String _failureMessage(AppLocalizations localizations) {
    ...
    return switch (failure.kind) {
      DistributionFailureKind.network =>
        localizations.distributionNetworkError,
      DistributionFailureKind.notFound =>
        localizations.distributionOrderNotFound,
      DistributionFailureKind.server =>
        localizations.distributionServerError,
