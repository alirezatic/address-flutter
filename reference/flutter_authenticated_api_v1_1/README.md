# Flutter Authenticated API v1.1
...
powershell -executionpolicy bypass -file .\reference\flutter_authenticated_api_v1_1\apply_flutter_authenticated_api_v1_1.ps1
```
