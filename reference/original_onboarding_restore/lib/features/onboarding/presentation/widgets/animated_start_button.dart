...
class _AnimatedStartButtonState extends State<AnimatedStartButton>
  ...
  Widget build(BuildContext context) {
    final buttonWidth = context.screenHeight * 0.25;
    final buttonHeight = context.screenWidth * 0.1432;
    final textSize = context.screenWidth * 0.045;
    final iconSize = context.screenWidth * 0.07;
    final loaderSize = context.screenWidth * 0.055;
