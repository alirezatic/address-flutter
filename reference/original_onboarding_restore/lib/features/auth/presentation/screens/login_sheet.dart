...
class _LoginSheetState extends State<LoginSheet> {
  ...
  Future<void> _handleLogin() async {
    ...
    final rawPhone =
        _mobileNumberController.text.toEnglishDigit().trim();
  ...
  void _handleErrorMessage(LoginError error) {
    ...
    final message = switch (error) {
      ...
      LoginError.invalidLength11 =>
        localizations.enterMobileErrorWithZero,
      LoginError.invalidLength10 =>
        localizations.enterMobileErrorWithoutZero,
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                isRtl
                    ? _countryDialCode.toPersianDigit()
                    : _countryDialCode,
