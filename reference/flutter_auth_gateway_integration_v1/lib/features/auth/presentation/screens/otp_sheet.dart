...
class _OtpSheetState extends State<OtpSheet> {
  ...
  void didUpdateWidget(covariant OtpSheet oldWidget) {
    ...
    if (oldWidget.challenge.challengeId ==
  ...
  void _applyDevelopmentOtp() {
    ...
    final developmentOtp =
        _otpFlowController.challenge.developmentOtp;

    if (developmentOtp == null || developmentOtp.length != 6) {
      return;
    }
  ...
  void _showControllerError() {
    ...
    final message = switch (_otpFlowController.currentError) {
      ...
      OtpError.tooManyRequests =>
        localizations.otpRequestTooSoon,
          ...
          child: Directionality(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final fieldSize = ((pinAreaWidth - 30) / 6)
                    .clamp(38, 48)
                    .toDouble();
