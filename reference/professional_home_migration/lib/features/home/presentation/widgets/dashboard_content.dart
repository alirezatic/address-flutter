            ...
            SafeArea(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final contentWidth =
                      viewportWidth.clamp(0, 1120).toDouble();

                  final carouselWidth =
                      contentWidth.clamp(300, 780).toDouble();

                  final carouselHeight =
                      (carouselWidth * 0.47).clamp(250, 340).toDouble();

                  final logoWidth =
                      (viewportWidth * 0.30).clamp(190, 280).toDouble();

                  final crossAxisCount = contentWidth < 680 ? 2 : 3;
                  final sectionAspectRatio =
                      contentWidth < 430 ? 1.65 : 2.15;
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return AnimatedBuilder(
                                        ...
                                        builder: (context, child) {
                                          ...
                                          final tilt =
                                              (pageOffset * 0.10).clamp(
                                            -0.16,
                                            0.16,
                                          );

                                          final parallax = pageOffset * 24;
